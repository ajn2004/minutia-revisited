...
- [x] Inventory and document historical MATLAB/CUDA variants.
- [x] Add installable Python package metadata and backend-neutral scientific modules.
- [x] Implement synthetic Gaussian/astigmatic frames and pixel-integrated model.
- [x] Implement canonical detector, NMS, quality oracle, and bounded replay buffer.
